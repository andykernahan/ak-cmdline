...
namespace AK.CmdLine.Impl.Utility
{
    ...
    /// </remarks>
    internal struct HashCodeBuilder : IEquatable<HashCodeBuilder>
    {
        #region Fields.
        ...
        {
            return _hashCode.ToString(CultureInfo.CurrentCulture);
        }
        ...
        public static bool operator ==(HashCodeBuilder x, HashCodeBuilder y)
        {
            return x.Equals(y);
        }
