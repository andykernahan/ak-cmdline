...
namespace AK.CmdLine.Impl.Utility
{
    ...
    public class IndentedTextWriter : TextWriter
    {
        ...
        /// </summary>
        public int IndentLength => String.IsNullOrEmpty(IndentString) ? 0 : IndentLevel * IndentString.Length;
        ...
        /// </summary>
        protected TextWriter Inner { get; }

        /// <summary>
        /// Gets or sets a value indicating if an indent is pending.
        /// </summary>
        protected bool IsIndentPending { get; set; }
