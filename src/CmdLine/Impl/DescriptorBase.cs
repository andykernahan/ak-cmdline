...
namespace AK.CmdLine.Impl
{
    ...
    public abstract class DescriptorBase
    {
        ...
        /// </summary>
        public string ShortName => _shortName ?? (_shortName = With<ShortNameAttribute>(x => x.ShortName));

        /// <summary>
        /// Gets a description of this descriptor.
        /// </summary>
        public string Description => _description ?? (_description = With<DescriptionAttribute>(x => x.Description));
